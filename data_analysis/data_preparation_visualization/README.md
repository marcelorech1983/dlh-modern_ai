...
Exploratory data analysis and preprocessing pipeline on the Telco Customer Churn dataset: describing and cleaning raw data, visualizing distributions and relationships, statistical feature selection, and preparing features for modeling.
...
- `Telco-Customer-Churn.csv` — raw dataset, used for tasks 0–5 (7,043 rows, 21 columns)
- `precleaned-Telco-Customer-Churn.csv` — cleaned version (post tasks 0–5), used for tasks 6–17

## Requirements

- Python 3.11, pycodestyle 2.14.0
- numpy 2.0.2, pandas 2.2.2, scikit-learn 1.6.1, matplotlib 3.10.0, seaborn 0.13.2, scipy 1.16.0, pillow 11.3.0
