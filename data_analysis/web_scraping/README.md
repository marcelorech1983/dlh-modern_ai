...
| 1 | Basic Static Scraping | `1-scrape_basic.py` | Not started |
| 2 | Pagination Handling | `2-scrape_paginated.py` | Not started |
| 3 | API-Based Scraping | `3-scrape_via_api.py` | Not started |
| 4 | JSON-LD Extraction | `4-extract_jsonld.py` | Not started |
